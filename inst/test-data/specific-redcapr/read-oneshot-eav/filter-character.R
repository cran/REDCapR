structure(list(record_id = 5L, name_first = "John Lee", name_last = "Walker", 
    ...
    mugshot = 26L, race___123456 = FALSE, ethnicity = 2L, interpreter_needed = 0L, 
    demographics_complete = 2L, health_complete = 0L, race_and_ethnicity_complete = 2L), row.names = c(NA, 
